...
const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'A productivity app for organizing daily tasks and projects.',
  ...
  return (
    <div className="py-12 px-4 bg-gray-50 relative"> {/* Added relative positioning */}
      ...
      <div className="max-w-6xl mx-auto">
        <Swiper
          ...
          onSlideChange={(swiper) => {
            swiper.slides.forEach((slide, index) => {
              ...
              slideEl.style.opacity = index === swiper.activeIndex ? '1' : '0.5';
            });
          }}
          onInit={(swiper) => {
            swiper.slides.forEach((slide, index) => {
              const slideEl = slide as HTMLElement;
              slideEl.style.opacity = index === swiper.activeIndex ? '1' : '0.6';
            });
          }}
        >
        ...
        <div className="swiper-button-prev bg-white p-4 rounded-full shadow-md hover:bg-gray-100"></div>
        <div className="swiper-button-next bg-white p-4 rounded-full shadow-md hover:bg-gray-100"></div>
      </div>
    </div>
  );
};
